    ...
    <section aria-label="Funding Method">
      ...
      <div className="mt-4 grid gap-6 xl:grid-cols-2">
        ...
        <div className="flex flex-col items-center gap-[17px]">
          <Link
            href="/add-funds/stablecoins-deposit"
            className="block w-full rounded-2xl focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-border-strong focus-visible:ring-offset-2"
          >
